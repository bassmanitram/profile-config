...
"""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            resolver = ProfileConfigResolver("myapp", profile="default", search_home=False)
            ...
            resolver_dev = ProfileConfigResolver("myapp", profile="development", search_home=False)
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            for env_value, description in test_cases:
                ...
                resolver = ProfileConfigResolver("myapp", profile=env, search_home=False)
                config = resolver.resolve()
